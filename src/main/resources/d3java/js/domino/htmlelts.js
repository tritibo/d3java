...
var CSSStyleDeclaration = require('d3java/js/domino/CSSStyleDeclaration');
var utils = require('d3java/js/domino/utils');
var URLUtils = require('d3java/js/domino/URLUtils');
var defineElement = require('d3java/js/domino/defineElement');
...
define({
  ...
  ctor: function HTMLIFrameElement(doc, localName, prefix) {
    HTMLElement.call(this, doc, localName, prefix);
    var Window = require('d3java/js/domino/Window'); // Avoid circular dependencies.
